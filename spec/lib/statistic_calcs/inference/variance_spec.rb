...
RSpec.describe StatisticCalcs::Inference::Variance do
  ...
  context 'Errors' do
    ...
    describe 'raise validation error' do
      ...
      it 'should fill all the attributes' do
        expect { subject.calc! }.to raise_error(StandardError, 'limits_relationship_variance is required to calculate the sample size')
      end
    end
    ...
    describe 'raise validation error' do
      ...
      it 'should fill all the attributes' do
        expect { subject.calc! }.to raise_error(StandardError, 'limits_relationship_variance <> 1 is required to calculate the sample size')
      end
    end
  end
end
