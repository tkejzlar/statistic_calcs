...
# rspec ./spec/lib/statistic_calcs/distributions/pascal_spec.rb
require 'statistic_calcs/distributions/pascal'

RSpec.describe StatisticCalcs::Distributions::Pascal do
  subject { StatisticCalcs::Distributions::Pascal.new(options) }
