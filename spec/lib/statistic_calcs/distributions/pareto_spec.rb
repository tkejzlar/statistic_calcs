...
# rspec ./spec/lib/statistic_calcs/distributions/pareto_spec.rb
require 'statistic_calcs/distributions/pareto'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::Pareto do
  subject { StatisticCalcs::Distributions::Pareto.new(options) }
