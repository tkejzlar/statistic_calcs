...
# rspec ./spec/lib/statistic_calcs/distributions/poisson_spec.rb
require 'statistic_calcs/distributions/poisson'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::Poisson do
  subject { StatisticCalcs::Distributions::Poisson.new(options) }
