...
# rspec ./spec/lib/statistic_calcs/distributions/geometric_spec.rb
require 'statistic_calcs/distributions/geometric'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::Geometric do
  subject { StatisticCalcs::Distributions::Geometric.new(options) }
