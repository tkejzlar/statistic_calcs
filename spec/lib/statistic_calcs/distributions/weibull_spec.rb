...
# rspec ./spec/lib/statistic_calcs/distributions/weibull_spec.rb
require 'statistic_calcs/distributions/weibull'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::Weibull do
  subject { StatisticCalcs::Distributions::Weibull.new(options) }
