...
# rspec ./spec/lib/statistic_calcs/distributions/normal_spec.rb
require 'statistic_calcs/distributions/normal'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::Normal do
  subject { StatisticCalcs::Distributions::Normal.new(options) }
