...
# rspec ./spec/lib/statistic_calcs/distributions/binomial_spec.rb
require 'statistic_calcs/distributions/binomial'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::Binomial do
  subject { StatisticCalcs::Distributions::Binomial.new(options) }
