...
# rspec ./spec/lib/statistic_calcs/distributions/exponential_spec.rb
require 'statistic_calcs/distributions/exponential'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::Exponential do
  subject { StatisticCalcs::Distributions::Exponential.new(options) }
