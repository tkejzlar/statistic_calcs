...
# rspec ./spec/lib/statistic_calcs/distributions/t_student_spec.rb
require 'statistic_calcs/distributions/t_student'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::TStudent do
  subject { StatisticCalcs::Distributions::TStudent.new(options) }
