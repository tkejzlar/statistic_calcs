...
# rspec ./spec/lib/statistic_calcs/distributions/hypergeometric_spec.rb
require 'statistic_calcs/distributions/hypergeometric'

RSpec.describe StatisticCalcs::Distributions::Hypergeometric do
  subject { StatisticCalcs::Distributions::Hypergeometric.new(options) }
