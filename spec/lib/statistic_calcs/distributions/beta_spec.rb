...
# rspec ./spec/lib/statistic_calcs/distributions/beta_spec.rb
require 'statistic_calcs/distributions/beta'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::Beta do
  subject { StatisticCalcs::Distributions::Beta.new(options) }
