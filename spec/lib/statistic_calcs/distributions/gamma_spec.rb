...
# rspec ./spec/lib/statistic_calcs/distributions/gamma_spec.rb
require 'statistic_calcs/distributions/gamma'

# rubocop:disable BlockLength
RSpec.describe StatisticCalcs::Distributions::Gamma do
  subject { StatisticCalcs::Distributions::Gamma.new(options) }
